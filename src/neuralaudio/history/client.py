...
class HistoryClient:
    ...
    def get_all(
        ...
        *,
        ...
        voice_id : typing.Optional[str]
            Voice ID to be filtered for, you can use GET https://api.neuralaudio.solutions/v1/voices to receive a list of voices and their IDs.
    ...
    def get(
        ...
        ----------
        history_item_id : str
            History item ID to be used, you can use GET https://api.neuralaudio.solutions/v1/history to receive a list of history items and their IDs.
    ...
    def download(
        ...
        *,
        ...
        ----------
        history_item_ids : typing.Sequence[str]
            A list of history items to download, you can get IDs of history items and other metadata using the GET https://api.neuralaudio.solutions/v1/history endpoint.
