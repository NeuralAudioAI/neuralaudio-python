...
class NeuralAudio(BaseNeuralAudio):
    """
    ...
    Parameters:
        ...
        - environment: NeuralAudioEnvironment. The environment to use for requests from the client. from .environment import NeuralAudioEnvironment

                                              Defaults to NeuralAudioEnvironment.PRODUCTION
    ...
    def __init__(
        ...
        *,
        ...
        environment: NeuralAudioEnvironment = NeuralAudioEnvironment.PRODUCTION,
        api_key: typing.Optional[str] = os.getenv("NEURALAUDIO_API_KEY"),
    ...
    def generate(
      ...
      *,
      ...
      model: Union[ModelId, Model] = "na_base_v1",
...
class AsyncNeuralAudio(AsyncBaseNeuralAudio):
    """
    Use this class to access the different functions within the SDK. You can instantiate any number of clients with different configuration that will propogate to these functions.
    ...
    ---
    from neuralaudio.client import AsyncNeuralAudio
