...
class BaseNeuralAudio:
    ...
    environment : NeuralAudioEnvironment
        The environment to use for requests from the client. from .environment import NeuralAudioEnvironment
...
def _get_base_url(*, base_url: typing.Optional[str] = None, environment: NeuralAudioEnvironment) -> str:
